...
?>
				...
				<?php $profile_user_obj = new User($con, $username); 
					...
					if($userLoggedIn != $username) {
						...
						if($logged_in_user_obj->isFriend($username)) {
							...
							echo '<input type="submit" name="" class="warning" value="Request Send"> <br> ';
						}
						else {
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <p>This will appear on the user's profile page and also their newsfeed for yours friend to see! </p>
		...
		$(document).ready(function() {
			...
			$(window).scroll(function() {
				var height = $('.posts_area').height(); // Div contaning posts
