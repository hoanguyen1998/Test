...
class Message {
	...
	public function getLastestMessage($userLoggedIn, $user2) {
		...
		//Timeframe
					...
					$interval = $start_date->diff($end_date); // Difference between date 
					if($interval->y >= 1) {
						if($interval == 1) {
	...
	public function getConvos() {
		...
		foreach ($convos as $username) {
			...
			$lastest_message_details = $this->getLastestMessage($userLoggedIn, $username);
			...
			$return_string .= "<a href='messages.php?u=$username'> <div class='user_found_messages'>
							...
							<span class='timestamp_smaller' id='grey'>" . $lastest_message_details[2] .
							"</span> <p id='grey' style='margin: 0;'>" . $lastest_message_details[0] . $split . " </p>
							</div>
							</a>";
